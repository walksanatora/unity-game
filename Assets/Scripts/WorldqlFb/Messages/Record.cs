...
public struct Record : IFlatbufferObject
{
  ...
  public static Offset<WorldqlFb.Messages.Record> CreateRecord(FlatBufferBuilder builder,
    ...
    Record.AddFlex(builder, flexOffset);
    Record.AddData(builder, dataOffset);
    Record.AddWorldName(builder, world_nameOffset);
    Record.AddPosition(builder, WorldqlFb.Messages.Vec3d.Pack(builder, position));
    Record.AddUuid(builder, uuidOffset);
  ...
  public static Offset<WorldqlFb.Messages.Record> EndRecord(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WorldqlFb.Messages.Record>(o);
  }
  ...
  public static Offset<WorldqlFb.Messages.Record> Pack(FlatBufferBuilder builder, RecordT _o) {
    if (_o == null) return default(Offset<WorldqlFb.Messages.Record>);
